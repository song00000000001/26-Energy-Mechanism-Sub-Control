...
#define USE_SRML_TIMER                    0   // 不能置零，drv_uart和inv_mpu等底层库有用到
#define USE_SRML_UART                     0   // 不能置零，与底层的耦合度很高
#define USE_SRML_FLASH                    0
#define USE_SRML_I2C                      0
#define USE_SRML_SPI                      0
#define USE_SRML_VIRTUAL_COM              0   // 虚拟串口
// Motor
#define USE_SRML_MOTOR_DJI                0   // RM电机
...
/* Middlewares -----------------------------------------------*/
// Abstract_class_lib
#define USE_SRML_ABS_LIB                  0   // 各种抽象库
// Algorithm
#define USE_SRML_PID                      0   // PID计算器,若开启，滤波器库也得开启，两个库有耦合
#define USE_SRML_FILTER                   0   // 滤波器库
#define USE_SRML_KALMAN                   0   // 卡尔曼滤波，依赖矩阵运算库，需要开启USE_SRML_MATH
#define USE_SRML_DIFF_CALCULATER          0   // 微分计算器
#define USE_SRML_MATH                     0   // 移植的数学运算库，包括矩阵、欧拉角、四元数等运算
#define USE_SRML_STATISTICS               0   // 统计类
// Module
